...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	return D3DApplication::GetApp()->MsgProc(hwnd, msg, wParam, lParam);
}
...
D3DApplication::D3DApplication(HINSTANCE hInstance)
	: mhAppInst(hInstance)
{
	// Only one D3DApplication can be constructed.
	assert(mApp == nullptr);
	mApp = this;
}
...
HINSTANCE D3DApplication::AppInst()const
{
	return mhAppInst;
}
...
bool D3DApplication::Get4xMsaaState()const
{
	return m4xMsaaState;
}

void D3DApplication::Set4xMsaaState(bool value)
{
...
bool D3DApplication::InitMainWindow()
{
	...
	wc.hIcon = LoadIcon(0, MAKEINTRESOURCE(IDI_DX12LEARN));
